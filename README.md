...
👁️:eye:[**Pupil Detection**](https://github.com/danycywiak/pupil-detection-hough) - Pupil detection algorithm based on Hough Circle Transform (classical computer vision).
